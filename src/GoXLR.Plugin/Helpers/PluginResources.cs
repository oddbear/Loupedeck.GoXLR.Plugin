namespace Loupedeck.GoXLRPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.GoXLRPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.GoXLRPlugin.Resources.Resource.txt`.
